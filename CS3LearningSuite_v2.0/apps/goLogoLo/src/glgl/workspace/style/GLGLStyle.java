...
public class GLGLStyle {
    ...
    public static final String CLASS_GLGL_BODY          = "glgl_body";
    public static final String CLASS_GLGL_ITEM_PANE          = "glgl_item_pane";
    public static final String CLASS_GLGL_FUNCTION_PANE          = "glgl_function_pane";
