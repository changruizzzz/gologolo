...
public enum GoLoPropertyType {
    ...
    // THIS IS THE GLGL WORKSPACE PANE
    GLGL_PANE,
    GOLOGOLO_LABEL,
    ...
    // FOOLPROOF SETTINGS
    GLGL_FOOLPROOF_SETTINGS,
    
    // DIALOG CONTROLS    
    GLGL_ITEM_DIALOG_HEADER_LABEL,
    GLGL_ITEM_DIALOG_RENAME_LABEL,
    GLGL_ITEM_DIALOG_RESIZE_HEADER_TEXT,
    GLGL_ITEM_DIALOG_RENAME_HEADER_TEXT,
    GLGL_ITEM_DIALOG_HEIGHT_TEXT_FIELD,
    GLGL_ITEM_DIALOG_WIDTH_TEXT_FIELD,
    GLGL_ITEM_DIALOG_RENAME_TEXT_FIELD,
    
    GLGL_TEXT_DIALOG_ADD_HEADER_TEXT,
    GLGL_TEXT_DIALOG_HEADER,
    GLGL_TEXT_DIALOG_TEXT_LABEL,
    GLGL_TEXT_DIALOG_TEXT_FIELD,
    GLGL_TEXT_DIALOG_EDIT_HEADER_TEXT,
    GLGL_TEXT_DIALOG_TEXT_LABEL_TEXT,
    
    GLGL_ITEM_DIALOG_HEIGHT_LABEL,
    GLGL_ITEM_DIALOG_WIDTH_LABEL,
    GLGL_ITEM_DIALOG_TITLE_LABEL,
    GLGL_ITEM_DIALOG_CONFIRM_PANE,
    GLGL_ITEM_DIALOG_OK_BUTTON,
