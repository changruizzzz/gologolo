...
/**
 *
 * @author McKillaGorilla, Changrui Zhou
 */
public class ToDoWorkspace extends AppWorkspaceComponent {
	...
	VBox toDoListPane           = tdlBuilder.buildVBox(TDLM_PANE,               null,           null,   CLASS_TDLM_BOX, HAS_KEY_HANDLER,             FOCUS_TRAVERSABLE,      ENABLED);
        ...
        Button moveItemUpButton     = tdlBuilder.buildIconButton(TDLM_MOVE_ITEM_UP_BUTTON,     itemButtonsPane,    null,   CLASS_TDLM_BUTTON, HAS_KEY_HANDLER,   FOCUS_TRAVERSABLE,  DISABLED);
        Button moveItemDownButton   = tdlBuilder.buildIconButton(TDLM_MOVE_ITEM_DOWN_BUTTON,   itemButtonsPane,    null,   CLASS_TDLM_BUTTON, HAS_KEY_HANDLER,   FOCUS_TRAVERSABLE,  DISABLED);
