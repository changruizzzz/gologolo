...
public enum AppPropertyType {
    ...
    HAS_WELCOME_DIALOG, HAS_TITLE_LABEL,
    HAS_TOP_TOOLBAR,
    HAS_FILE_TOOLBAR, HAS_CLIPBOARD_TOOLBAR, HAS_UNDO_TOOLBAR, HAS_HELP_TOOLBAR, HAS_ZOOM_TOOLBAR,
    HAS_NEW, HAS_LOAD, HAS_CLOSE, HAS_SAVE, HAS_EXPORT, HAS_EXIT,
    HAS_HELP, HAS_LANGUAGE, HAS_ABOUT,
    HAS_UNDO, HAS_REDO,
    HAS_ZOOM_IN, HAS_ZOOM_OUT, HAS_RESET_VIEW, HAS_RESIZE,
    ...
    ZOOM_IN_BUTTON, ZOOM_OUT_BUTTON, RESIZE_BUTTON, RESET_VIEW_BUTTON, SNAP_BOX, SNAP_BUTTON,
    ...
    EXPORT_SUCCESS_CONTENT, EXPORT_WORK_TITLE,
